...
model = load_model(r'D:\Nicolaus Kevin PH\SEMS 5\ML\Pert 13\Tugas6_A_11796\model_googlenet.h5')  # Update with your model path
...
st.title("Prediksi Kematangan Buah Naga - 1796")
...
<div style="text-align: center; margin-top: 5px; font-size: 14px; color: #FFF; opacity: 0.8;">
    © 2024 Nicolaus Kevin Putra Hardito. All Rights Reserved.
</div>
"""
